...
#       temporary focusing, currently focusing, and target
#       focusing, target
#
##############################################################################
...
if "$cygwin" || "$msys" ; then
    ...
    for arg do
        ...
        # temporary it was, but possibly modified.
        #
        # NB: a)://bugs.java.com/view_bug.do?bug_id=6344811
        #     b)://bugs.java.com/view_bug.do?bug_id=6264416
